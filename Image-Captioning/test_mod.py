...
def process_caption(sd, caption):
    ...
    # print("token",tokens)
    # print("sd is ", sd.wor)
    # terminate_id = sd.word_index['<end>']
...
def generate_captions(sd, model, encoded_images, beam_size):
    ...
    last_word = [sd.word_index['<end>']]
    # print("last word", last_word)
    # print("inside sd", sd.__dict__)
    prob_level = 0.0
    ...
    # print("capt_seq", capt_seq)
    best_caption = " ".join([sd.index_word[index] for index in best_caption]) + ' <end>'
