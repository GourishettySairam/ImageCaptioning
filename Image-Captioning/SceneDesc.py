...
from keras.layers import LSTM, Embedding, TimeDistributed, Dense, Merge, RepeatVector, Activation, Concatenate
...
class scenedesc():
	...
	def create_model(self, ret_model = False):
		...
		#model.add([image_model, lang_model]);
		#model.add();
